...
const AddSubscriptionPlan = ({ addPlan, setAddPlan }) => {
  ...
  useEffect(() => {
    ...
    register({ name: 'priceAnnually' }, createOptions.priceAnnually);
  }, []);
          ...
          <Modal.Description>
            ...
            <Form.Field className='mb-3'>
              ...
              <Form.Input
                ...
                onChange={handleChange}
                onBlur={handleChange}
                error={!!errors.priceAnnually}
              />
              {errors && errors.priceAnnually && (
                <Message error content={errors.priceAnnually.message} />
              )}
            </Form.Field>
          </Modal.Description>
        </Form>
